...
$app->get('/order/:idorder', function($idorder) {
    ...
    $tpl = new Page();
    $tpl->setTpl('payment', ['order' => $order->get($idorder)]);
});

$app->get('/order/boleto/:idorder', function($idorder) {
    ...
    $user = User::getUserById($order->getUser_id());


    // DADOS DO BOLETO PARA O SEU CLIENTE
    $dias_de_prazo_para_pagamento = $order->getNrdays();
    $taxa_boleto = 5.00;
...
// DADOS DO SEU CLIENTE
    $dadosboleto["sacado"] = $user['person_name'];
...
// NÃO ALTERAR!
    ...
    include("plugins/boletophp/include/layout_itau.php");
});
