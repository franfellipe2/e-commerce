                    ...
                    <table class="shop_table">
                        ...
                        <tfoot>
                            <tr class="cart-subtotal">
                                <th>Subtotal</th>
                                <td><span class="amount">R$<?php echo htmlspecialchars( $order["vltotal"] - $order["vlfreight"], ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
                                </td>
                            </tr>
                            <tr class="shipping">
                                <th>Frete</th>
                                <td>
                                    R$<?php echo htmlspecialchars( $order["vlfreight"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
