<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="list-group" id="menu">
    ...
    <a href="<?php echo htmlspecialchars( $HOME, ENT_COMPAT, 'UTF-8', FALSE ); ?>/profile" class="list-group-item list-group-item-action">Alterar Senha</a>
    ...
    <a href="<?php echo htmlspecialchars( $HOME, ENT_COMPAT, 'UTF-8', FALSE ); ?>/logout" class="list-group-item list-group-item-action">Sair</a>
</div>