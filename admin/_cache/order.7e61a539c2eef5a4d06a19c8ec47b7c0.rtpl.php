...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo htmlspecialchars( $ADMIN_URL, ENT_COMPAT, 'UTF-8', FALSE ); ?>/orders">Pedidos</a></li>
        <li class="active"><a href="<?php echo htmlspecialchars( $ADMIN_URL, ENT_COMPAT, 'UTF-8', FALSE ); ?>/orders/<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">Pedido N°<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a></li>
    </ol>
    </section>
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            Para
            <address>
                <strong><?php echo htmlspecialchars( $order["person_name"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong><br>
                ...
                <?php if( $order["person_phone"] && $order["person_phone"]!='0' ){ ?>Telefone: <?php echo htmlspecialchars( $order["person_phone"], ENT_COMPAT, 'UTF-8', FALSE ); ?><br><?php } ?>
                E-mail: <?php echo htmlspecialchars( $order["person_mail"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
            </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <button type="button" onclick="window.location.href = '<?php echo htmlspecialchars( $ADMIN_URL, ENT_COMPAT, 'UTF-8', FALSE ); ?>/orders/<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/status'" class="btn btn-default pull-left" style="margin-left: 5px;">
                    <i class="fa fa-pencil"></i> Editar Status
                </button>
                <button type="button" onclick="window.open('<?php echo htmlspecialchars( $HOME, ENT_COMPAT, 'UTF-8', FALSE ); ?>/order/boleto/<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>')" class="btn btn-default pull-left" style="margin-left: 5px;">
