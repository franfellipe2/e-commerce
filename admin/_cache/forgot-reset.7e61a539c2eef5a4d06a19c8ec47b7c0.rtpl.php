...
<div class="lockscreen-wrapper">
  ...
  <div class="lockscreen-item">
    ...
    <form  action="<?php echo htmlspecialchars( $ADMIN_URL, ENT_COMPAT, 'UTF-8', FALSE ); ?>/forgot/reset" method="post">
      <input type="hidden" class="form-control" name="code" value="<?php echo htmlspecialchars( $code, ENT_COMPAT, 'UTF-8', FALSE ); ?>">
