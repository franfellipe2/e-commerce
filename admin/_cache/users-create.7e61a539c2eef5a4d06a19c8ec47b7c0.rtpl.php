        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-success">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="<?php echo htmlspecialchars( $ADMIN_URL, ENT_COMPAT, 'UTF-8', FALSE ); ?>/users/create" method="post">
                        <div class="box-body">
                            ...
                            <div class="form-group <?php if( !empty($error["user_pass"]) ){ ?>has-warning<?php } ?>">
                                <label for="user_pass">Senha</label>
                                <input type="password" class="form-control" id="user_pass" name="user_pass" placeholder="Digite a senha">
                                <span class="help-block"><?php if( !empty($error["user_pass"]) ){ ?><?php echo htmlspecialchars( $error["user_pass"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php } ?></span>
                            </div>
                            <div class="form-group <?php if( !empty($error["user_rpass"]) ){ ?>has-warning<?php } ?>">
                                ...
                                <span class="help-block"><?php if( !empty($error["user_rpass"]) ){ ?><?php echo htmlspecialchars( $error["user_rpass"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php } ?></span>
                            </div>
                            <div class="checkbox">                                
