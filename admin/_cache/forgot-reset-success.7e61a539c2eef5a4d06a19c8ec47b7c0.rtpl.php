...
<div class="lockscreen-wrapper">
  <div class="lockscreen-logo">
    <a href="<?php echo htmlspecialchars( $ADMIN_URL, ENT_COMPAT, 'UTF-8', FALSE ); ?>/index2.html"><b>Admin</b>LTE</a>
  </div>
  ...
  <div class="help-block text-center">
    <div class="callout callout-success">
      ...
      <p>Tente fazer o login com sua nova senha.<br><a href="<?php echo htmlspecialchars( $ADMIN_URL, ENT_COMPAT, 'UTF-8', FALSE ); ?>/login">Clique aqui</a> para fazer o login.</p>
    </div>
  </div>
