...
<div class="lockscreen-wrapper">
  ...
  <div class="lockscreen-item">
    ...
    <form  action="<?php echo htmlspecialchars( $ADMIN_URL, ENT_COMPAT, 'UTF-8', FALSE ); ?>/forgot/" method="post">
  ...
  <div class="text-center">
    <a href="<?php echo htmlspecialchars( $ADMIN_URL, ENT_COMPAT, 'UTF-8', FALSE ); ?>/login">Or sign in as a different user</a>
  </div>
